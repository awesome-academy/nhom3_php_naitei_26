...
@section('content')
    <div class="mb-5">
        <h1 class="text-2xl font-bold text-gray-950">Tạo dịch vụ công mới</h1>
        <p class="mt-1 text-sm text-gray-600">Thêm một loại dịch vụ công mới vào hệ thống.</p>
    </div>
    ...
    <section class="admin-card">
        ...
        <form action="{{ route('admin.service-types.store') }}" method="POST" class="admin-card-body">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" name="code" id="code" value="{{ old('code') }}" class="admin-input" required>
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" class="admin-input" required>
                ...
                <div>
                    ...
                    <input type="number" name="fee" id="fee" value="{{ old('fee', 0) }}" class="admin-input" min="0" required>
                ...
                <div>
                    ...
                    <input type="number" name="processing_time_days" id="processing_time_days" value="{{ old('processing_time_days', 1) }}" class="admin-input" min="1" required>
            ...
            <div class="mt-6 flex items-center gap-3">
                ...
                <input type="checkbox" name="is_active" id="is_active" value="1" @checked(old('is_active', true)) class="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary">
            ...
            <div class="mt-6">
                ...
                <textarea name="description" id="description" rows="3" class="admin-input !h-auto">{{ old('description') }}</textarea>
            ...
            <div class="mt-6">
                ...
                <textarea name="requirements" id="requirements" rows="3" class="admin-input !h-auto">{{ old('requirements') }}</textarea>
            ...
            <div class="mt-6" x-data="{
                items: ({{ json_encode(old('document_requirements', [])) }}).map(r => ({
                    code: r.code ?? '',
                    name: r.name ?? r.label ?? '',
            ...
            <div class="mt-6" x-data="{
                items: {{ json_encode(old('form_schema', [])) }},
            ...
            <div class="mt-8 flex justify-end gap-3 border-t border-border pt-5">
                ...
                <x-admin.button type="submit">Tạo dịch vụ</x-admin.button>
            </div>
        </form>
    </section>
@endsection
